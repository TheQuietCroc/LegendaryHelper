...
public interface HeroDao extends CardDao<HeroEntity> {
    ...
    // findByName
    @Override
    @Query("SELECT * FROM tblHero WHERE name LIKE :name LIMIT 1")
    ...
    // findById
    @Override
    @Query("SELECT * FROM tblHero WHERE id = :id LIMIT 1")
    ...
    // getAll
    @Override
    @Query("SELECT * FROM tblHero ORDER BY id ASC")
    ...
    // getAllEnabled
    @Override
    @Query("SELECT * FROM tblHero WHERE isEnabled = 1 ORDER BY id ASC")
    ...
    // getAllBySetId
    @Override
    @Query("SELECT * FROM tblHero WHERE setId = :setId ORDER BY id ASC")
